...
test(`swapcase: should swap the cases of each individual letter in the string`, t => {
  const caseSwapped = stringops.swapcase('HeLlO wOrLd!');

  t.is(caseSwapped, 'hElLo WoRlD!');
});